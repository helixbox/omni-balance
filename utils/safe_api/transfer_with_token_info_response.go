...
type TransferWithTokenInfoResponse struct {
	...
	// Transfer id
	//
	// Internally calculated parameter to uniquely identify a transfer
...
func (m *TransferWithTokenInfoResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateTransferID(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *TransferWithTokenInfoResponse) contextValidateTransferID(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "transferId", "body", string(m.TransferID)); err != nil {
		return err
	}
