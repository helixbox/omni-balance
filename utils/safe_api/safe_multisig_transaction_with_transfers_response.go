...
func (m *SafeMultisigTransactionWithTransfersResponse) validateProposer(formats strfmt.Registry) error {
...
func (m *SafeMultisigTransactionWithTransfersResponse) contextValidateOrigin(ctx context.Context, formats strfmt.Registry) error {
