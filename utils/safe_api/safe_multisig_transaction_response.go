...
func (m *SafeMultisigTransactionResponse) validateProposer(formats strfmt.Registry) error {
...
func (m *SafeMultisigTransactionResponse) contextValidateOrigin(ctx context.Context, formats strfmt.Registry) error {
