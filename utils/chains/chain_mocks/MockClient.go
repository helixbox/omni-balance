...
func (_m *MockClient) BalanceAt(ctx context.Context, account common.Address, blockNumber *big.Int) (*big.Int, error) {
...
func (_m *MockClient) BlockByHash(ctx context.Context, hash common.Hash) (*types.Block, error) {
...
func (_m *MockClient) BlockByNumber(ctx context.Context, number *big.Int) (*types.Block, error) {
...
func (_m *MockClient) BlockNumber(ctx context.Context) (uint64, error) {
	ret := _m.Called(ctx)
...
func (_m *MockClient) CallContract(ctx context.Context, call ethereum.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (_m *MockClient) ChainID(ctx context.Context) (*big.Int, error) {
	ret := _m.Called(ctx)
...
func (_m *MockClient) CodeAt(ctx context.Context, account common.Address, blockNumber *big.Int) ([]byte, error) {
	ret := _m.Called(ctx, account, blockNumber)
...
func (_m *MockClient) EstimateGas(ctx context.Context, call ethereum.CallMsg) (uint64, error) {
...
func (_m *MockClient) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*ethereum.FeeHistory, error) {
...
func (_m *MockClient) FilterLogs(ctx context.Context, q ethereum.FilterQuery) ([]types.Log, error) {
	ret := _m.Called(ctx, q)
...
func (_m *MockClient) HeaderByHash(ctx context.Context, hash common.Hash) (*types.Header, error) {
	ret := _m.Called(ctx, hash)
...
func (_m *MockClient) HeaderByNumber(ctx context.Context, number *big.Int) (*types.Header, error) {
	ret := _m.Called(ctx, number)
...
func (_m *MockClient) NonceAt(ctx context.Context, account common.Address, blockNumber *big.Int) (uint64, error) {
	ret := _m.Called(ctx, account, blockNumber)
...
func (_m *MockClient) PendingBalanceAt(ctx context.Context, account common.Address) (*big.Int, error) {
...
func (_m *MockClient) PendingCallContract(ctx context.Context, call ethereum.CallMsg) ([]byte, error) {
	ret := _m.Called(ctx, call)
...
func (_m *MockClient) PendingCodeAt(ctx context.Context, account common.Address) ([]byte, error) {
	ret := _m.Called(ctx, account)
...
func (_m *MockClient) PendingNonceAt(ctx context.Context, account common.Address) (uint64, error) {
	ret := _m.Called(ctx, account)
...
func (_m *MockClient) PendingStorageAt(ctx context.Context, account common.Address, key common.Hash) ([]byte, error) {
...
func (_m *MockClient) PendingTransactionCount(ctx context.Context) (uint, error) {
	ret := _m.Called(ctx)
...
func (_m *MockClient) SendTransaction(ctx context.Context, tx *types.Transaction) error {
...
func (_m *MockClient) StorageAt(ctx context.Context, account common.Address, key common.Hash, blockNumber *big.Int) ([]byte, error) {
...
func (_m *MockClient) SubscribeFilterLogs(ctx context.Context, q ethereum.FilterQuery, ch chan<- types.Log) (ethereum.Subscription, error) {
...
func (_m *MockClient) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (ethereum.Subscription, error) {
...
func (_m *MockClient) SuggestGasPrice(ctx context.Context) (*big.Int, error) {
	ret := _m.Called(ctx)
...
func (_m *MockClient) SuggestGasTipCap(ctx context.Context) (*big.Int, error) {
	ret := _m.Called(ctx)
...
func (_m *MockClient) TransactionByHash(ctx context.Context, txHash common.Hash) (*types.Transaction, bool, error) {
...
func (_m *MockClient) TransactionCount(ctx context.Context, blockHash common.Hash) (uint, error) {
...
func (_m *MockClient) TransactionInBlock(ctx context.Context, blockHash common.Hash, index uint) (*types.Transaction, error) {
...
func (_m *MockClient) TransactionReceipt(ctx context.Context, txHash common.Hash) (*types.Receipt, error) {
	ret := _m.Called(ctx, txHash)
