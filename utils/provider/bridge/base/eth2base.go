...
// 			bridge:    common.HexToAddress("0x3154Cf16ccdb4C6d922629664174b904d80F2C35"),
// 		},
// 	}
...
//
// 	err := Approve(ctx, EthereumChianId, tokenConfig.l1Address, tokenConfig.bridge,
...
// 	res, err := WaitForChildTransactionReceipt(ctx, txHash, trader)
// 	if err != nil {
// 		return "", err
// 	}
// 	if res.Complete {
